...
<div id="services" class="services">
    ...
    <div id="send-feedback">
        <p class="text-lg text-gray-800 mb-6 text-center">Send Feedback</p>
        <form id="feedbackForm" action="${pageContext.request.contextPath}/feedback" method="post" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="comments" required class="border p-2 w-full rounded h-32"></textarea>
            </div>
            <div>
            ...
            <button type="submit" class="bg-indigo-500 text-white px-4 py-2 rounded hover:bg-indigo-600">Send Feedback</button>
        </form>
    </div>
